...
@section('content')
    ...
    <section class="contactus-page" id="contactus">
        <div class="container">
            <div class="row">
                <!DOCTYPE html>
                <html lang="en">
                ...
                <body>
                    ...
                    <section class="ftco-section" id="meetings">
                        <div class="container align-items-center justify-content-cneter">
                            <div class="content">
                                <div class="left-side">
                                    <div class="address details">
                                        <i class="fas fa-map-marker-alt"></i>
                                        <div class="topic">Alamat</div>
                                        <div class="text-one">Jl. Lingkar Barat Siliwangi, Nogosaren, RT.05/RW.22</div>
                                        <div class="text-two">Nogotirto, Gamping, Sleman, D.I. Yogyakarta</div>
                                    </div>
                                    <div class="phone details">
                                        <i class="fas fa-phone-alt"></i>
                                        <div class="topic">Telp.</div>
                                        <div class="text-one"><a href="tel://+6285701246319">0857-0124-6319</a></div>
                                    </div>
                                    <div class="email details">
                                        <i class="fas fa-envelope"></i>
                                        <div class="topic">Email</div>
                                        <div class="text-one"><a
                                                href="trilogikaedutamayk@gmail.com">trilogikaedutamayk@gmail.com</a></div>
                                    </div>
                                </div>
                                <div class="right-side">
                                    <div class="topic-text">Send us a message</div>
                                    <p>If you have any work from me or any types of quries related to my tutorial, you can
                                        send me message from here. It's my pleasure to help you.</p>
                                    <form action="#">
                                        <div class="input-box">
