                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="tempat_lahir" id=""
                                                        class="form-control" value="{{ $userData->tempat_lahir }}">
                                                </div>
                                            </div>
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    <input type="date" name="tanggal_lahir" id=""
                                                        class="form-control" value="{{ $userData->tanggal_lahir }}">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                            ...
                                            <div class="col-md-8">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="nama_sekolah" id=""
                                                        class="form-control" value="{{ $userData->nama_sekolah }}">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-12 mt-5 mb-2">
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="kode_pos" id=""
                                                        class="form-control" value="{{ $userData->kode_pos }}">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                    ...
                                    <div class="col-md-12 mt-5 mb-2">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="nama_institusi" id="" value="{{ $dataPekerjaan->nama_institusi }}"
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="jabatan" id="" value="{{ $dataPekerjaan->jabatan }}"
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="alamat_kantor" id="" value="{{ $dataPekerjaan->alamat_kantor }}"
                                                    class="form-control" placeholder="">
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                <label for="">Kode Pos</label>
                                                <input type="text" name="kode_pos_kantor" id="" value="{{ $dataPekerjaan->kode_pos_kantor }}"
                                                    class="form-control" placeholder="">
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                <label for="">Nomor Telepon</label>
                                                <input type="text" name="tlp_kantor" id="" value="{{ $dataPekerjaan->tlp_kantor }}"
                                                    class="form-control" placeholder="">
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                <label for="">Email</label>
                                                <input type="text" name="email_kantor" id="" value="{{ $dataPekerjaan->email_kantor }}"
                                                    class="form-control" placeholder="">
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                <label for="">Fax</label>
                                                <input type="text" name="fax_kantor" id="" value="{{ $dataPekerjaan->fax_kantor }}"
                                                    class="form-control" placeholder="">
                                            </div>
                                        </div>
