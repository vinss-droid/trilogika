    ...
    <div class="page-title">
        <div class="row">
            <div class="col-12 col-md-6 order-md-1 order-last">
                <h3>Form Perubahan Bukti Persyaratan</h3>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <small class="text-muted">File Maksimal 1 MB format pdf  <a href="#" class="badge bg-primary">{{ Str::substr($berkas->ijazah, 14)  }}</a></small>
                                @error('ijazah')
                                <small class="text-danger">{{ $message }}</small>
                                @enderror
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <small class="text-muted">File Maksimal 1 MB format pdf <a href="#" class="badge bg-primary">{{ Str::substr($berkas->pas_foto, 16)  }}</a></small>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <small class="text-muted">File Maksimal 1 MB format pdf <a href="#" class="badge bg-primary">{{ Str::substr($berkas->sk_kerja, 16)  }}</a></small>
